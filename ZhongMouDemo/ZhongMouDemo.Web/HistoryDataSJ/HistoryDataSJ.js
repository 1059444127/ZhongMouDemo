...
jQuery(document).ready(function ($) {
	...
	var ajaxData = {
	    "Table": [{
	        "水位1": Math.round(Math.random() * 10000) / 100,
	        "水位2": Math.round(Math.random() * 10000) / 100,
	        "水位3": Math.round(Math.random() * 10000) / 100,
	        "水位4": Math.round(Math.random() * 10000) / 100,
	        "水位5": Math.round(Math.random() * 10000) / 100,
	        "水位6": Math.round(Math.random() * 10000) / 100,
