...
jQuery(document).ready(function ($) {
	...
	var ajaxData = {
	    "Table": [{
	        "气温1": Math.round(Math.random() * 10000) / 100,
	        "气温2": Math.round(Math.random() * 10000) / 100,
	        "气温3": Math.round(Math.random() * 10000) / 100,
	        "气温4": Math.round(Math.random() * 10000) / 100,
	        "气温5": Math.round(Math.random() * 10000) / 100,
	        "气温6": Math.round(Math.random() * 10000) / 100,
