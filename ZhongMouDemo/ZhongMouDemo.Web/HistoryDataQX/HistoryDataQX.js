...
jQuery(document).ready(function ($) {
	...
	var ajaxData = {
	    "Table": [{
	        "温度1": Math.round(Math.random() * 10000) / 100,
	        "温度2": Math.round(Math.random() * 10000) / 100,
	        "温度3": Math.round(Math.random() * 10000) / 100,
	        "温度4": Math.round(Math.random() * 10000) / 100,
	        "温度5": Math.round(Math.random() * 10000) / 100,
	        "温度6": Math.round(Math.random() * 10000) / 100,
